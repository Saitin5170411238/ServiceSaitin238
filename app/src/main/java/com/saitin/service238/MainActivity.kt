...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //button istagram jika diklik akan menampilkan halaman instagram.com
        ...
        var MediaPlayer: MediaPlayer? = MediaPlayer.create(this, R.raw.surah)

        //button yg berfungsi untuk memutar mp3

        btn_play.setOnClickListener{
            MediaPlayer?.start()
        }

        //button untuk melakukan pause mp3
